...
export function ContactBlock() {
  ...
  return (
    <div className="w-full bg-[#1e1e1e] text-white py-12 relative overflow-hidden">
      <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: "url('/mattress-bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 justify-center md:justify-start">
            ...
            <div className="space-y-4 text-center md:text-left">
              ...
              <div className="flex items-center gap-4 justify-center md:justify-start">
                ...
                className="bg-white text-black p-2 rounded-full hover:bg-slate-200 transition-colors">
